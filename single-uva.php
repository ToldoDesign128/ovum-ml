                ...
                <div class="w-full flex flex-wrap">
                    ...
                    if ($scheda_valore_17) : ?>
                        <div class="w-full flex flex-row items-center justify-between py-[10px] border-b  border-gray-950">
                            ...
                            <p class="lg:w-1/2 w-auto lg:text-left text-right lg:text-[16px] text-[13px] lg:leading-[22px] leading-[16px] tracking-[.32px]"><?php echo esc_html($scheda_valore_17); ?></p>
                        </div>
                    <?php endif;
                    if ($scheda_valore_18) : ?>
                        <div class="w-full flex flex-row items-center justify-between py-[10px] border-b  border-gray-950">
                            ...
                            <p class="lg:w-1/2 w-auto lg:text-left text-right lg:text-[16px] text-[13px] lg:leading-[22px] leading-[16px] tracking-[.32px]"><?php echo esc_html($scheda_valore_18); ?></p>
                        </div>
                    <?php endif; ?>
                    <?php
                    // Check rows exists.
