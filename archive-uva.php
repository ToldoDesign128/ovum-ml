...
<section class="hero h-screen relative">
    <img class="absolute lg:block hidden top-0 left-0 w-full h-full object-cover" src="<?php echo get_template_directory_uri() . '/assets/img/hero/ML_uva-header.jpg'; ?>">
    <img class="absolute lg:hidden block top-0 left-0 w-full h-full object-cover" src="<?php echo get_template_directory_uri() . '/assets/img/hero/uva_2.jpg'; ?>">
    ...
    <div class="container h-screen mx-auto flex flex-col lg:justify-center justify-start items-center">
        ...
        <p class="lg:w-[416px] w-[322px] font-primary text-center lg:text-[20px] leading-[32px] tracking-[.4px] text-gray-950 z-10 lg:mt-[35px] mt-[20px]">
