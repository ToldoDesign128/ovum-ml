...
?>
    <section class="xl:max-w-screen-xl lg:max-w-screen-lg md:max-w-screen-md mx-auto px-[26px] lg:mb-[150px] mb-[60px]">
                ...
                while ($loop->have_posts()) : $loop->the_post(); ?>
                    ...
                    <div class="swiper-slide font-primary font-light flex flex-col items-center">
                        ...
                        ?>
                            ...
                            <p class="text-center lg:text-[40px] text-[22px] lg:leading-[50px] leading-[28px] lg:tracking-normal tracking-[.44px] border-b border-gray-500 lg:pb-[35px] pb-[30px]"><?php echo esc_html($recensione_testo) ?></p>
